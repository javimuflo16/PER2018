...
def process_client(clientsocket):
    ...
    aux=str(mensaje_solicitud).split("\n")
    trz= aux[0].split(" ")
    ...
    if trz[1]=="/blue.html" or trz[1]== "/blue":
        file_html="blue.html"

    elif trz[1]=="/index.html" or trz[1]== "/index" or trz[1]== "/":
    ...
    #    FILE_HTML = "blue.html"
    #elif "index.html" in mensaje_solicitud:
    #    FILE_HTML= "index.html"
    #elif "" in mensaje_solicitud:
    #    FILE_HTML="index.html"
    #else:
    #    FILE_HTML="error.html"
    ...
    # el mismo fic-hero, se pida lo que se le pida
